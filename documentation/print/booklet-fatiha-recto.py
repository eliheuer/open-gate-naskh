...
text("ملك يوم الديـــــــــــــــــــــن",            (U*14.9,   U*38))
text("إياك نعبد وإياك نستعين",   (U*15.,  U*34))
...
font("fonts/ttf/OpenGateNaskh-Regular.ttf")
fontSize(U*2)
text("١٩",                                      (U*23.39, U*62.4))

font("fonts/ttf/OpenGateNaskh-Regular.ttf")
fontSize(U*4)
text("سورة الفاتحة",           (U*15.7, U*56))

font("fonts/ttf/OpenGateNaskh-Regular.ttf")
fontSize(U*1.6)
text("١",           (U*12.85, U*49.5))
text("٢",           (U*12.75, U*45.5))
text("٣",           (U*12.65, U*41.5))
text("٤",           (U*12.80, U*37.5))
text("٥",           (U*12.72, U*33.5))
text("٦",           (U*12.65, U*29.5))
text("٧",           (U*19.65, U*13.5))
